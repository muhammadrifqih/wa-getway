                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-green-700">
                        ...
                        <div class="mt-3 flex items-center gap-2" x-data="{ copied: false }">
                            ...
                            <button @click="navigator.clipboard.writeText('{{ $newlyCreatedKey }}'); copied = true; setTimeout(() => copied = false, 2000)" 
                                    class="ml-2 inline-flex items-center px-3 py-2 border border-green-300 shadow-sm text-sm leading-4 font-medium rounded-md text-green-700 bg-white hover:bg-green-50 focus:outline-none transition">
                                <span x-show="!copied" class="flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                                    Copy
                                </span>
                                <span x-show="copied" x-cloak class="flex items-center gap-1 text-green-600">
